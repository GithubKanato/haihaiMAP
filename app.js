const defaultPlaces = [
  ...
  {
    id: "asobono-haihai-garden",
    name: "ASOBono! ハイハイガーデン",
    lat: 35.7056,
    lng: 139.753,
    type: "indoor",
    category: "indoor",
    quiet: false,
    score: 94,
    tags: ["東京", "文京区", "はいはい", "ベビー専用", "屋内"],
    note: "東京ドームシティ内の屋内型キッズ施設。0-24か月専用のハイハイガーデンがある。",
    area: "東京都文京区後楽",
    bestTime: "平日午前、休日は開館直後",
    facilities: ["ハイハイガーデン", "ベビー専用", "授乳室", "おむつ替え", "屋内"],
    ground: "0-24か月専用エリア。はいはい目的にかなり向く。",
    crowd: "休日や雨の日は入場待ち・混雑に注意。",
    caution: "料金・利用時間・混雑状況を公式で確認。",
    source: "東京ドームシティ ASOBono!公式",
    sourceUrl: "https://www.tokyo-dome.co.jp/asobono/",
  },
  {
    id: "tokyo-toy-museum-baby",
    name: "東京おもちゃ美術館 赤ちゃん木育ひろば",
    lat: 35.6894,
    lng: 139.7193,
    type: "indoor",
    category: "indoor",
    quiet: true,
    score: 92,
    tags: ["東京", "新宿区", "赤ちゃん木育", "屋内", "おもちゃ"],
    note: "赤ちゃん向けの木育ひろばがある屋内ミュージアム。床で遊ぶ乳幼児向き。",
    area: "東京都新宿区四谷",
    bestTime: "平日午前、予約枠の早い時間",
    facilities: ["赤ちゃん木育ひろば", "木のおもちゃ", "授乳", "おむつ替え", "屋内"],
    ground: "赤ちゃん向けエリアで床に近い遊びがしやすい。",
    crowd: "休日は親子連れで混みやすい。",
    caution: "入館方法・予約・対象年齢を公式で確認。",
    source: "東京おもちゃ美術館公式",
    sourceUrl: "https://art-play.or.jp/ttm/",
  },
  {
    id: "fantasy-kids-tama",
    name: "ファンタジーキッズリゾート多摩 ミルキッズひろば",
    lat: 35.6247,
    lng: 139.4247,
    type: "indoor",
    category: "indoor",
    quiet: false,
    score: 88,
    tags: ["東京", "多摩市", "乳幼児専用", "屋内", "キッズ施設"],
    note: "乳幼児向けのミルキッズひろばがある大型屋内遊び場。",
    area: "東京都多摩市落合",
    bestTime: "平日午前、休日は開店直後",
    facilities: ["ミルキッズひろば", "授乳室", "おむつ替え", "屋内遊具", "駐車場"],
    ground: "乳幼児向けエリアを選ぶ。はいはいは専用スペース内で。",
    crowd: "休日や長期休みは混雑しやすい。",
    caution: "利用料金・会員登録・対象年齢を確認。",
    source: "ファンタジーキッズリゾート公式",
    sourceUrl: "https://www.fantasyresort.jp/tama/",
  },
  {
    id: "kidokid-yomiuriland",
    name: "キドキド よみうりランド店 ベビーガーデン",
    lat: 35.6255,
    lng: 139.5175,
    type: "indoor",
    category: "indoor",
    quiet: false,
    score: 87,
    tags: ["東京", "稲城市", "ベビーガーデン", "屋内", "ボーネルンド"],
    note: "6か月から18か月向けのベビーガーデン情報がある屋内あそび場。",
    area: "東京都稲城市矢野口",
    bestTime: "平日午前、休日は早め",
    facilities: ["ベビーガーデン", "授乳", "おむつ替え", "屋内遊具", "ベビーカー"],
    ground: "ベビー向け区画で床遊びしやすい。",
    crowd: "休日や遊園地混雑日は人が増えやすい。",
    caution: "対象月齢・料金・営業日を公式で確認。",
    source: "ボーネルンド キドキド公式",
    sourceUrl: "https://kidokid.bornelund.co.jp/yomiuriland/",
  },
  {
    id: "minato-appi-azabu",
    name: "港区 あっぴぃ麻布",
    lat: 35.6539,
    lng: 139.7351,
    type: "indoor",
    ...
    quiet: true,
    score: 86,
    tags: ["東京", "港区", "子育てひろば", "乳幼児", "屋内"],
    note: "乳幼児親子が利用できる港区の子育てひろば。屋内で落ち着いて過ごしやすい。",
    area: "東京都港区麻布十番",
    bestTime: "平日午前、イベントのない時間",
    facilities: ["子育てひろば", "授乳", "おむつ替え", "屋内", "一時預かり"],
    ground: "乳幼児向けひろば。はいはいは現地の区画を確認。",
    crowd: "イベント時間や雨の日は混みやすい。",
    caution: "区施設の利用条件・休館日を確認。",
    source: "港区子育てひろば あっぴぃ麻布公式",
    sourceUrl: "https://www.appy-azabu.jp/",
  },
  {
    id: "poppins-kids-uehara",
    name: "ポピンズキッズひろば上原",
    lat: 35.6693,
    lng: 139.6818,
    type: "indoor",
    ...
    quiet: true,
    score: 85,
    tags: ["東京", "渋谷区", "子育てひろば", "乳幼児", "屋内"],
    note: "渋谷区の乳幼児親子向けひろば。地域の親子休憩・交流に使いやすい。",
    area: "東京都渋谷区上原",
    bestTime: "平日午前、混雑前",
    facilities: ["子育てひろば", "授乳", "おむつ替え", "屋内", "相談"],
    ground: "乳幼児向け室内ひろば。床遊びは現地ルールに従う。",
    crowd: "時間帯により地域利用者で混みやすい。",
    caution: "区の利用条件・開室日を確認。",
    source: "渋谷区/ポピンズキッズひろば上原",
    sourceUrl: "https://www.city.shibuya.tokyo.jp/kodomo/hoiku/kosodate-shien/poppins-uehara.html",
  },
  {
    id: "chuo-akachan-tengoku-horidome",
    name: "中央区 あかちゃん天国 堀留町児童館",
    lat: 35.6897,
    lng: 139.7793,
    type: "indoor",
    category: "babyroom",
    quiet: true,
    score: 84,
    tags: ["東京", "中央区", "あかちゃん天国", "乳幼児", "屋内"],
    note: "中央区の乳幼児専用ひろば。赤ちゃん親子が床で過ごしやすい区施設。",
    area: "東京都中央区日本橋堀留町",
    bestTime: "平日午前、混雑前",
    facilities: ["乳幼児ひろば", "授乳", "おむつ替え", "児童館", "屋内"],
    ground: "乳幼児向けのひろば。はいはい・床遊び候補。",
    crowd: "地域利用が多い時間帯は混みやすい。",
    caution: "対象年齢・利用登録・開館日を区公式で確認。",
    source: "中央区 あかちゃん天国公式",
    sourceUrl: "https://www.city.chuo.lg.jp/a0021/kosodate/shien/akachantengoku/index.html",
  },
  {
    id: "bunkyo-edogawabashi-hiroba",
    name: "文京区 子育てひろば江戸川橋",
    lat: 35.7098,
    lng: 139.7337,
    type: "indoor",
    ...
    quiet: true,
    score: 83,
    tags: ["東京", "文京区", "子育てひろば", "乳幼児", "屋内"],
    note: "文京区の乳幼児親子向け子育てひろば。屋内で休憩・交流しやすい。",
    area: "東京都文京区関口",
    bestTime: "平日午前、イベント外の時間",
    facilities: ["子育てひろば", "授乳", "おむつ替え", "屋内", "相談"],
    ground: "乳幼児向け室内ひろば。はいはいは混雑と区画を確認。",
    crowd: "講座やイベント時間は混みやすい。",
    caution: "区公式の利用案内・休館日を確認。",
    source: "文京区 子育てひろば公式",
    sourceUrl: "https://www.city.bunkyo.lg.jp/b010/p004156.html",
  },
  {
    id: "parthenon-tama-olive",
    name: "パルテノン多摩 こどもひろばOLIVE",
    lat: 35.6246,
    lng: 139.429,
    type: "indoor",
    category: "indoor",
    quiet: true,
    score: 82,
    tags: ["東京", "多摩市", "こどもひろば", "乳幼児", "屋内"],
    note: "パルテノン多摩内のこどもひろば。親子で休憩しやすい屋内スポット。",
    area: "東京都多摩市落合",
    bestTime: "平日午前、催しの少ない時間",
    facilities: ["こどもひろば", "屋内", "ベビーカー", "トイレ", "休憩"],
    ground: "乳幼児向けスペースの状況を確認して利用。",
    crowd: "催事日や休日は人が増えやすい。",
    caution: "施設イベントと利用可能時間を確認。",
    source: "パルテノン多摩公式",
    sourceUrl: "https://www.parthenon.or.jp/",
  },
  {
    id: "tokyo-solamachi-babyroom",
    name: "東京ソラマチ ベビー休憩室",
    lat: 35.7101,
    lng: 139.8107,
    type: "indoor",
    ...
    quiet: false,
    score: 80,
    tags: ["東京", "墨田区", "ベビー休憩室", "授乳室", "屋内"],
    note: "各階のベビー休憩室・授乳室案内がある大型商業施設。観光中の休憩に使いやすい。",
    area: "東京都墨田区押上",
    bestTime: "平日午前、観光ピーク前",
    facilities: ["ベビー休憩室", "授乳室", "おむつ替え", "給湯", "屋内"],
    ground: "休憩室中心。はいはい目的より授乳・おむつ替え・一時休憩向き。",
    crowd: "休日・観光ピークはかなり混みやすい。",
    caution: "はいはい用プレイスペースの有無は現地で確認。",
    source: "東京ソラマチ公式",
    sourceUrl: "https://www.tokyo-solamachi.jp/service/",
  },
  {
    id: "cafe-melody-setagaya",
    name: "カフェメロディ",
    lat: 35.6422,
    lng: 139.6028,
    type: "indoor",
    ...
    quiet: true,
    score: 86,
    tags: ["東京", "世田谷区", "カフェ", "キッズスペース", "赤ちゃんふらっと"],
    note: "とうきょう子育てスイッチでキッズスペース、ベビーカー入店可、禁煙が確認できるカフェ。",
    area: "東京都世田谷区成城",
    bestTime: "昼過ぎの混雑前、営業日確認後",
    facilities: ["キッズスペース", "ベビーカー", "禁煙", "ノンカフェイン", "赤ちゃんふらっと"],
    ground: "キッズスペースあり。はいはいは床面と混雑を現地確認。",
    crowd: "小規模カフェのため席数と混雑を確認したい。",
    caution: "営業日・営業時間・キッズスペース利用可否を事前確認。",
    source: "とうきょう子育てスイッチ",
    sourceUrl: "https://kosodateswitch.metro.tokyo.lg.jp/facility/flat/3683",
  },
  {
    id: "himemaru-cafe",
    name: "ひめまるcafe",
    ...
    quiet: true,
    score: 88,
    tags: ["東京", "台東区", "カフェ", "キッズスペース", "ベビーカー"],
    note: "靴を脱いで入れる扉付きキッズスペースがある子連れ歓迎カフェ。",
    area: "東京都台東区東浅草",
    bestTime: "平日午前から昼前",
    facilities: ["扉付きキッズスペース", "粉ミルク用お湯", "ベビーカー", "スロープ", "屋内"],
    ground: "靴を脱いで入れるキッズスペース。はいはい候補として強め。",
    crowd: "小規模店舗のため混雑・貸切・営業状況に注意。",
    caution: "不定休・営業時間変動あり。訪問前に確認。",
    source: "とうきょう子育てスイッチ",
    sourceUrl: "https://kosodateswitch.metro.tokyo.lg.jp/shop/23402",
  },
  {
    id: "kotocafe-fuchu",
    name: "親子カフェ kotocafe",
    ...
    quiet: true,
    score: 89,
    tags: ["東京", "府中市", "親子カフェ", "キッズスペース", "授乳室"],
    note: "キッズスペースを見ながら食事でき、授乳室・おむつ交換設備もある親子カフェ。",
    area: "東京都府中市宮町",
    bestTime: "平日ランチ早め、予約できる時間",
    facilities: ["キッズスペース", "授乳室", "おむつ交換", "キッズプレート", "電子レンジ"],
    ground: "親子カフェのキッズスペース。はいはいは対象年齢と混雑を確認。",
    crowd: "イベントやランチ時間は混みやすい。",
    caution: "営業情報・予約・イベント開催日を公式で確認。",
    source: "kotocafe公式",
    sourceUrl: "https://www.kotocafe.jp/",
  },
  {
    id: "en-cafe-kuramae",
    name: "en cafe 蔵前",
    ...
    quiet: true,
    score: 82,
    tags: ["東京", "台東区", "カフェ", "小上がり", "授乳室"],
    note: "小上がり席、授乳室、おむつ替えスペース情報がある蔵前のカフェ。",
    area: "東京都台東区蔵前",
    bestTime: "平日午前から昼前",
    facilities: ["小上がり", "授乳室", "おむつ替え", "ベビーカー", "屋内"],
    ground: "小上がり席で赤ちゃんを寝かせやすい。はいはいは席状況次第。",
    crowd: "人気エリアのため昼時は混みやすい。",
    caution: "2階席や階段情報あり。ベビーカー利用は事前確認。",
    source: "en cafe公式/子連れレビュー",
    sourceUrl: "https://www.enkuramae.com",
  },
  {
    id: "yutaly-ones-cafe",
    name: "Yutaly One's Cafe",
    lat: 35.703,
    lng: 139.499,
    type: "indoor",
    category: "cafe",
    quiet: true,
    score: 84,
    tags: ["東京", "小金井市", "カフェ", "キッズスペース", "おむつ替え"],
    note: "おむつ替えスペースやキッズスペースがある、親子で過ごしやすいカフェ。",
    area: "東京都小金井市貫井北町",
    bestTime: "平日午前、混雑前",
    facilities: ["キッズスペース", "おむつ替え", "カフェ", "屋内", "親子向け"],
    ground: "キッズスペースあり。はいはいは床面と広さを現地確認。",
    crowd: "地域カフェのため席数・混雑を確認。",
    caution: "営業日・キッズスペース利用条件を確認。",
    source: "Yutaly One's Cafe公式",
    sourceUrl: "https://yutaly.com/",
  },
];
